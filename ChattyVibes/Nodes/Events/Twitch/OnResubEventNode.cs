...
namespace ChattyVibes.Nodes.Events.Twitch
{
    ...
    internal class OnResubEventNode : BaseEventNode
    {
        ...
        protected override void OnCreate()
        {
            ...
            m_op_CumMonths_out = OutputOptions.Add("Cumulative Months", typeof(string), false);
        ...
        private void OnEventNode_RaiseEvent(object sender, OnReSubscriberArgs e)
        {
            ...
            m_op_CumMonths_out.TransferData(e.ReSubscriber.MsgParamCumulativeMonths);
            m_op_ShouldShareStreak_out.TransferData(e.ReSubscriber.MsgParamShouldShareStreak);
            m_op_StreakMonths_out.TransferData(e.ReSubscriber.MsgParamStreakMonths);
            m_op_ResubMessage_out.TransferData(e.ReSubscriber.ResubMessage);
            m_op_SubPlan_out.TransferData(e.ReSubscriber.SubscriptionPlan.ToString());
