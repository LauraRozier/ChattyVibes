...
namespace ChattyVibes.Nodes.Events.Twitch
{
    ...
    internal class OnGiftSubEventNode : BaseEventNode
    {
        ...
        protected override void OnCreate()
        {
            ...
            m_op_Months_out = OutputOptions.Add("Months", typeof(string), false);
            m_op_MultiMonthGiftDuration_out = OutputOptions.Add("Multi-month Gift Duration", typeof(string), false);
        ...
        private void OnEventNode_RaiseEvent(object sender, OnGiftedSubscriptionArgs e)
        {
            ...
            m_op_Months_out.TransferData(e.GiftedSubscription.MsgParamMonths);
            m_op_MultiMonthGiftDuration_out.TransferData(e.GiftedSubscription.MsgParamMultiMonthGiftDuration);
            m_op_RecipientDisplayName_out.TransferData(e.GiftedSubscription.MsgParamRecipientDisplayName);
            m_op_SubPlan_out.TransferData(e.GiftedSubscription.MsgParamSubPlan.ToString());
