...
namespace ChattyVibes.Nodes.Events.Twitch
{
    ...
    internal class OnNewSubEventNode : BaseEventNode
    {
        ...
        private void OnEventNode_RaiseEvent(object sender, OnNewSubscriberArgs e)
        {
            ...
            m_op_Months_out.TransferData(e.Subscriber.MsgParamCumulativeMonths);
            m_op_ShouldShareStreak_out.TransferData(e.Subscriber.MsgParamShouldShareStreak);
            m_op_StreakMonths_out.TransferData(e.Subscriber.MsgParamStreakMonths);
            m_op_ResubMessage_out.TransferData(e.Subscriber.ResubMessage);
            m_op_SubPlan_out.TransferData(e.Subscriber.SubscriptionPlan.ToString());
