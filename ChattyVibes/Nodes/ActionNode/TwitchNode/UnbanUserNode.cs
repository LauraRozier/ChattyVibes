...
{
    [STNode("/Actions/Twitch", "LauraRozier", "", "", "Twitch UnbanUser node")]
    internal sealed class UnbanUserNode : ActionNode
    {
        private string _channel = string.Empty;
        [STNodeProperty("Channel", "The channel to unban the user for.")]
        ...
        [STNodeProperty("Username", "The name of the user to unban.")]
        ...
        private void SendCommand(TwitchClient client, object data)
        {
            ...
            client.UnbanUser(dataObj.Channel, dataObj.Username);
        }
