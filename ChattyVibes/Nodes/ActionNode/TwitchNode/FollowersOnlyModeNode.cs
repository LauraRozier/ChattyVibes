...
{
    [STNode("/Actions/Twitch", "LauraRozier", "", "", "Twitch FollowersOnlyMode node")]
    internal sealed class FollowersOnlyModeNode : ActionNode
    {
        private string _channel = string.Empty;
        [STNodeProperty("Channel", "The name of the channel to change the FollowersOnly mode of.")]
        ...
        [STNodeProperty("Enabled", "Wether to enable or disable FollowersOnly mode.")]
        public bool Enabled
        {
            get { return _enabled; }
            set
        ...
        private void SendCommand(TwitchClient client, object data)
        {
            ...
            try
            {
                ...
                {
                    if (dataObj.Enabled)
                        client.FollowersOnlyOn(dataObj.Channel, new TimeSpan(dataObj.Days, dataObj.Hours, dataObj.Minutes, 0));
                    else
                        client.FollowersOnlyOff(dataObj.Channel);
                }
            } catch { }
        }
        ...
        protected override void OnCreate()
        {
            ...
            m_op_days_in = InputOptions.Add("Days (<= 90)", typeof(int), false);
