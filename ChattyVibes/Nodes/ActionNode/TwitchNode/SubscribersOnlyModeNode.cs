...
{
    [STNode("/Actions/Twitch", "LauraRozier", "", "", "Twitch SubscribersOnlyMode node")]
    internal sealed class SubscribersOnlyModeNode : ActionNode
    {
        private string _channel = string.Empty;
        [STNodeProperty("Channel", "The name of the channel to change the SubscribersOnly mode of.")]
        ...
        [STNodeProperty("Enabled", "Wether to enable or disable SubscribersOnly mode.")]
        public bool Enabled
        {
            get { return _enabled; }
            set
        ...
        private void SendCommand(TwitchClient client, object data)
        {
            ...
            try
            {
                ...
                {
                    if (dataObj.Enabled)
                        client.SubscribersOnlyOn(dataObj.Channel);
                    else
                        client.SubscribersOnlyOff(dataObj.Channel);
                }
            } catch { }
        }
