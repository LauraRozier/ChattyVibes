...
{
    [STNode("/Actions/Twitch", "LauraRozier", "", "", "Twitch ModUser node")]
    internal sealed class ModUserNode : ActionNode
    {
        private string _channel = string.Empty;
        [STNodeProperty("Channel", "The channel to mod the user for.")]
        ...
        [STNodeProperty("Username", "The name of the user to mod.")]
        ...
        private void SendCommand(TwitchClient client, object data)
        {
            ...
            client.Mod(dataObj.Channel, dataObj.Username);
        }
