...
namespace ChattyVibes.Nodes.Actions.Buttplug
{
    [STNode("/Actions/Buttplug", "LauraRozier", "", "", "Buttplug.IO SendVibrateCommand node")]
    internal class SendVibeCommandNode : BaseActionNode
    {
